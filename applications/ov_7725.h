...
void set_25fps(void);
void set_30fps(void);
void rmov_banding_50hz(void);
void rmov_banding_60hz(void);  //for 30fps
void set_wb_sunny(void);																	
void set_wb_cloudy(void);							
void set_wb_office(void);
void set_wb_home(void);
void set_wb_night(void);
void set_saturation(int n);
void set_brightness_plus(int n);
void set_brightness_minus(int n);
void set_eff_normal(void);
void set_eff_bw(void);
void set_eff_bluish(void);
void set_eff_sepia(void);
void set_eff_redish(void);
void set_eff_greenish(void);
